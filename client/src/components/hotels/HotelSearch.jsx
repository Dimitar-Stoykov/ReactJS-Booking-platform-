    ...
    return (
        <>
            <div className="relative -top-16 max-w-6xl mx-auto bg-white shadow-xl rounded-xl p-6">
                <form action="/search" method="get" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
                    <input type="text" name="country" placeholder="Enter Country" className="p-3 border rounded-lg" />
                    <input type="text" name="location" placeholder="Enter place" className="p-3 border rounded-lg" />
